...
После автоматического включения виртуальной машины (через окно VirtualBox не нужно запускать или выключать, всё через Vagrant в консоли) в командной строке вернётся стандартное приглашение ввода команд, тогда откройте в браузере ip-адрес `192.168.33.10`.
...
В `Vagrantfile` строка `vb.cpus = 2` задает два ядра для виртуального процессора, можно поставить другое количество, но лучше не больше количества ядер своего физического процессора.
